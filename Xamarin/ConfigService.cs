...
namespace Risersoft.Framework.Dependency
{
    public class ConfigService : IConfiguration
    {
        ...
        {
           //return "http://ednirvana.com";
        return "http://erp.qa.appsnirvana.com";
            //return "http://dse3.kanohar.net:56498";
        }
        ...
        public string AppList() {
            return "acc+cnf+def+exv+hrp+inv+mnt+pln+pro+pur+qly+sls+trp+unc";
        }
