...
Public Class HomeController
    ...
    Function Explore() As ActionResult
        Return Me.Redirect("http://www.risersoft.com/erp")
    End Function

    Function BuyApp() As ActionResult
        Dim portal As String = Me.Host.Portal.ToRootString
        Return Me.Redirect(portal & "/account/create?license=buy&product=EtomPlan")
    End Function

    Function TryApp() As ActionResult
        Dim portal As String = Me.Host.Portal.ToRootString
        Return Me.Redirect(portal & "/account/create?license=try&product=EtomPlan")
    End Function
End Class
